...
def get_dataloader(lang, goal, window_len, step_len, max_len_tokens,
    ...
    file_path_dict = {'fre': {'train': 'data/train_fr.csv',
                      ...
                      'vi': {'train': 'data/train_word_vi.csv',
                             'test': 'data/test_word_vi.csv',
                             'dev': 'data/test_20_en.csv'},
                      'ann_en': {'train': 'data/term/train_ann_en.csv',
                                 'test': 'data/term/test_ann_en.csv',
                                 'dev': 'data/term/test_ann_en.csv'},
                      'ann_fr': {'train': 'data/term/train_ann_fr.csv',
                                 'test': 'data/term/test_ann_fr.csv',
                                 'dev': 'data/term/test_ann_fr.csv'},
                      'ann_nl': {'train': 'data/term/train_ann_nl.csv',
                                 'test': 'data/term/test_ann_nl.csv',
                                 'dev': 'data/term/test_ann_nl.csv'},
                      'nes_en': {'train': 'data/term/train_nes_en.csv',
                                 'test': 'data/term/test_nes_en.csv',
                                 'dev': 'data/term/test_nes_en.csv'},
                      'nes_fr': {'train': 'data/term/train_nes_fr.csv',
                                 'test': 'data/term/test_nes_fr.csv',
                                 'dev': 'data/term/test_nes_fr.csv'},
                      'nes_nl': {'train': 'data/term/train_nes_nl.csv',
                                 'test': 'data/term/test_nes_nl.csv',
                                 'dev': 'data/term/test_nes_nl.csv'},
                      }
    if data_aug:
